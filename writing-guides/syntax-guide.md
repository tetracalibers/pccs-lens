...
**数式（KaTeX）の記法は `math-notation-guide.md` に切り出してあります。** 記事本文を書くときは、このガイドと合わせて両方に従ってください。
...
この規約のうち**数字は、インライン数式（`$$...$$`）を含む文でも変わりません**（インラインコードのままにします）。ただし関数名は、インライン数式を含む文ではインライン数式に統一します（→ `math-notation-guide.md`「インライン数式を含む文では、数式・変数・関数名をインライン数式に統一する」）。
...
数式（KaTeX）の記法は `math-notation-guide.md` に切り出してあります。インライン数式とインラインコードの使い分け、前後の半角スペース、`\dfrac`、複数行の改行などはそちらが正典です。**記事本文を書くときは、このガイドと合わせて必ずそちらにも従ってください。**
...
- [ ] 数式の記法（インライン数式とインラインコードの使い分け、前後の半角スペース、`\dfrac`、複数行の改行など）は、`math-notation-guide.md` の「仕上げチェックリスト（数式）」で確認している。
