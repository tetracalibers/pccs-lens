...
- RS-P053｜AI草稿がデモを差し込んだだけの箇所へ、人手で :::Action を後付けして「何を動かして何を観察するか」を明示する：完成本文側の型は TF-057／WS-065 が扱うが、修正傾向としては1記事1コミットの観察にとどまり、デモを持つ他記事の差分で再現を確認できていない｜支持: /cg/transformation/pinhole-camera
...
- RS-P055｜:::Todo を図版プレースホルダ以外にも使い、本文の語句やデモのラベルへの申し送りをその場に残して次のコミットで解消と同時に削除する：本体 RS-032 は図版の場所確保に限定した用法で、申し送り一般への拡張と解消・削除の運用は1記事でしか確認できていない｜支持: /cg/transformation/pinhole-camera
