...
<svelte:head>
  ...
  <link
    href="https://fonts.googleapis.com/css2?family=Delius+Swash+Caps&family=Reddit+Mono:wght@400..700&family=SUSE+Mono:wght@400;500&family=Zen+Kaku+Gothic+Antique:wght@400;500&display=swap"
    rel="stylesheet"
  />
</svelte:head>
...
<style>
  ...
  :global(body) {
    ...
    --font-fancy: "Delius Swash Caps", cursive;
