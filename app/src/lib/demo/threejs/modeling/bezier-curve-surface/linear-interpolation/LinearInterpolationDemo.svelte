...
<ThreeDemoCanvas
  ariaLabel="2つの制御点P₀・P₁を結ぶ線分と、その上の点C(t)を描いた図。線分はC(t)を境に2つに分かれ、P₀側にはP₀にかかる重み1 − t、P₁側にはP₁にかかる重みtが添えられている。tを動かすとC(t)が線分上を動き、2つの制御点にかかる混合比がパネルに表示される（ホイールで拡大縮小）"
