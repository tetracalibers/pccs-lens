...
<ThreeDemoCanvas
  ariaLabel="左に双曲線関数のグラフ、右に双曲線を並べた図。グラフは横軸がtで、cosh tとsinh tの2本の曲線が描かれ、cosh tは値1より下へ来ない。右の双曲線では、その2つの値を座標にとった点が右側の枝の上を動く。tを動かすと、グラフ上の2つの値と双曲線上の点が連動して変わり、符号を逆転させると点はxが負となる左側の枝へ移る（ホイールで拡大縮小）"
