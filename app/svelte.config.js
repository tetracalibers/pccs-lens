...
const directives = {
  container: [
    ...
    { name: "Delete", replaceTo: "svelte-component" },
    { name: "Add", replaceTo: "svelte-component" },
    { name: "Edit", replaceTo: "svelte-component" },
    { name: "Modify", replaceTo: "svelte-component" },
    { name: "Pending", replaceTo: "svelte-component" },
