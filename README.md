...
2. **草稿の執筆**：`/author-style-writer <slug>` で、本文の草稿を著者らしい文体で執筆する（3種類すべてに対応。含めたいキーワードをカンマ区切りで渡せる）。
3. **編集・手直し**：`/author-style-writer <slug> <編集指示>` で、すでに本文のあるページに編集を加える（執筆スタイルガイドに従い、前後の文章・セクションの流れも整える）。
